...
const About = () => {
  return (
    <div className="relative w-full py-24 flex justify-center items-center bg-ben10-background overflow-hidden">
      {/* Background blurs */}
      ...
      <div className="container mx-auto px-4">
        <h2 className="text-6xl font-['Rubik_Dirt'] text-ben10 text-center mb-16 drop-shadow-[4px_4px_0_rgba(0,0,0,0.3)]">
          ABOUT US
        </h2>
        ...
        <div className="glass-blur max-w-4xl mx-auto p-8 relative animate-scale-up border-2 border-ben10">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-2/3 text-center mb-8 md:mb-0">
              <p className="font-['Faster_One'] text-xl leading-relaxed text-ben10-light">
